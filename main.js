const createTask = (event) => {
  ...
  if (localStorage.getItem("cosas que tego que realisar en casa") === null) {
    //Crear una nueva lista de elementos de
    let todoList = [];

    //Añadir objeto que vendría siendo mi tarea por realizar, y la voy a mandar al array que se llama cosas que tego que realisar en casa
    todoList.push(task);
